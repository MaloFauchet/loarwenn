<a style="text-decoration:none;color:#011B43" href="<?="/frontOffice/offreDetaille/index.php?id=" . $valueOfOffre['id_offre'] ?>" class="a-card offre" data-category="<?= strtolower($valueOfOffre['type_offre']) ?>"" note_avis="<?php echo $valueOfOffre["note_avis"] ?>" location="<?= $valueOfOffre['nom_ville'] ?>" data-open-days="<?= $valueOfOffre['jours_ouverture'] ?>">    
