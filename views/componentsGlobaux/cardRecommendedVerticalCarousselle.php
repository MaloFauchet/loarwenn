...
<a style="text-decoration:none;color:#011B43;" href="<?php $_SERVER['DOCUMENT_ROOT']. "/frontOffice/offreDetaille/index.php?id=" . $valueOfOffre['id_offre'] ?>" class="a-card">
    <div >
        ...
        <div class="item-body">
            ...
            <div class="item-location">
                ...
                <div class="tel-card">
                    ...
                    <p>06 54 69 52 33  code postal</p>
                </div>
                <p>100-300 €</p>
            </div>
            <div class="item-avis">
