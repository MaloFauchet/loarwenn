<main>
    ...
    <div class="container">
        <nav>
            ...
            <a aria-label="Accueil" href="/"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
        ...
        <div class="form-container">
            <a aria-label="S'incrire" href="/backOffice/creationComptePro/" class="button-link"><button>S'inscrire</button></a>

            <p class="conditions">
                En créant un compte, vous acceptez nos
                <a href="#" aria-label="Conditions Génrérales">Conditions Générales</a> d'utilisation et notre
